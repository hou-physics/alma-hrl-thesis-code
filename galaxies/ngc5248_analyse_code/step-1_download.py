##############################################################################
# Step -1: ALMA archive download for NGC5248
#
# Generated by /alma-query on 2026-04-27; mousid switched to Xdf1 on 2026-04-28.
# Query details: results/NGC5248/download_query.md
#
# Scenario: B (FITS cube product)
# Project:  2017.1.00277.S
# Mousid:   uid://A001/X1296/Xdf1  (0.26" beam, sens 0.93 mJy, ~9.2 GB)
#
# Switched from Xdef (0.07" C43-9/10 long-baseline, MRS ~2-3") because that
# tier resolves out the entire ~30" NGC 5248 disk — direct cube probe showed
# no source detected in any SPW (CO, H30a, continuum). Xdf1 is the more
# compact-config tier in the same project; expected MRS ~6-10".
##############################################################################
...
MOUSID = "uid://A001/X1296/Xdf1"
REGEX  = r"_sci\..*\.cube\.I\.(pbcor\.fits|pb\.fits\.gz)$"
DEST   = Path("/Volumes/HouAstro/master/master_thesis/work_dir/NGC5248")
