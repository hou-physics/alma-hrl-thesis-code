##############################################################################
# Step -1: ALMA archive download for NGC7793
#
# Generated by /alma-query on 2026-04-23
# Query details: results/NGC7793/download_query.md
#
# Scenario: B (FITS cube product)
# Project:  2015.1.00782.S
# Mousid:   uid://A001/X2f7/X21d
##############################################################################
...
MOUSID = "uid://A001/X2f7/X21d"
# Manually restricted to spw0 (CO21) + spw1 (H30a). spw2 (244.5 GHz) and spw3
# (246.3 GHz) carry no HRL or CO lines for this z (0.000749) and are not used
# by the pipeline — dropping them cuts the download from ~147 GB to ~63 GB.
REGEX  = r"_sci\.spw[01]_.*\.cube\.I\.(pbcor\.fits|pb\.fits\.gz)$"
DEST   = Path("/Volumes/HouAstro/master/master_thesis/work_dir/NGC7793")
