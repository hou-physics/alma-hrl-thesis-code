##############################################################################
# Step -1: ALMA archive download for NGC5253
#
# Generated by /alma-query on 2026-04-24
# Query details: results/NGC5253/download_query.md
#
# Scenario: B (FITS cube product)
# Project:  2013.1.00210.S
#
# Mousid override: skill ranked uid://A001/X136/X1a top (0.19" res, 0.92 mJy/bm),
# but that dataset is 70 GB (exceeds large-download policy) and 0.19" over-resolves
# the compact nuclear starburst. Switched to uid://A001/X136/X1c (0.91" res,
# 2.05 mJy/bm, 3.64 GB) — better matched to the ~1" compact-starburst scale.
##############################################################################
...
MOUSID = "uid://A001/X136/X1c"
REGEX  = r"_sci\..*\.cube\.I\.(pbcor\.fits|pb\.fits\.gz)$"
DEST   = Path("/Volumes/HouAstro/master/master_thesis/work_dir/NGC5253")
