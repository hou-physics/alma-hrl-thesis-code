##############################################################################
# Step -1 (ACA tier): ALMA archive download for NGC5253 — 7-m Morita array
#
# Sanity test of the IRAS compact-starburst pivot after X1c (0.91") gave a
# non-detection (S/N 3.08 vs null p95 3.54). X1e is the 7-m ACA tier:
# 4.95" beam → one beam encloses the entire nuclear starburst, giving
# single-dish-like total-flux measurement of compact emission. If Bendo+2017's
# ~0.5–1 Jy·km/s is real, X1e should detect it cleanly despite worse per-beam
# sensitivity (9.53 mJy/bm vs X1a's 0.92), because the compact source sits in
# a single resolution element.
#
# Mousid: uid://A001/X136/X1e (ACA 7-m, 4.95", 9.53 mJy/bm, 0.43 GB)
##############################################################################
...
MOUSID = "uid://A001/X136/X1e"
REGEX  = r"_sci\..*\.cube\.I\.(pbcor\.fits|pb\.fits\.gz)$"
DEST   = Path("/Volumes/HouAstro/master/master_thesis/work_dir/NGC5253_aca")
