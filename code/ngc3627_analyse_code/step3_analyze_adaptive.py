"""NGC 3627 with full S1+N1 adaptive (mode=all already in canonical config)."""
import sys
...
config = replace(
    _base.config,  # already has mask_components_mode="all"
    ...
    nbeam_min=5,
    n_components_max=10,
    output_dir="/Volumes/HouAstro/master/results/NGC3627_adaptive",
)
